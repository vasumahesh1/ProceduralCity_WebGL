    ...
    create() {
        ...
        OBJ.downloadMeshes({
            ...
            for (var idx = 0; idx < wahoo.indices.length; ++idx) {
                ref.indices = concatUint32Array(ref.indices, new Uint32Array([
                    wahoo.indices[idx]
                ]));
            }
            ref.generateIdx();
            ...
            for (let i = 0; i < 1000; ++i) {
                ...
                instanceModels = concatFloat32Array(instanceModels, new Float32Array([
                    x, y, z, 1
                ]));
            }
...
//# sourceMappingURL=CubeInstanced.js.map